...
import { Sparkles, FileSpreadsheet, Zap, Radio } from "lucide-react";

export default function Home() {
  const [currentView, setCurrentView] = useState<"pipeline" | "csv">("pipeline");
  ...
  return (
    <div className="min-h-screen flex flex-col bg-neutral-950 text-neutral-100">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-1 bg-neutral-950/80 border border-neutral-800 p-1 rounded-xl shadow-inner">
            ...
            >
              ...
              <span>Trend Pipeline (Live Realtime)</span>
            </button>
            ...
            >
              ...
              <span>CSV & Inventory Fit Studio</span>
            </button>
          </div>
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-4 sm:p-6 lg:p-8 flex flex-col">
        {currentView === "pipeline" ? <TrendPipeline /> : <CsvStudio />}
      </main>
    </div>
  );
}
